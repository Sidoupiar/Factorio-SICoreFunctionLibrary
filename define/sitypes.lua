SITypes =
{
	...
	entity =
	{
		...
		belt           = "transport-belt" ,
		belt_g         = "underground-belt" ,
		belt_l         = "loader" ,
		belt_ls        = "loader-1x1" ,
		belt_s         = "splitter" ,
		pipe           = "pipe" ,
		pipe_g         = "pipe-to-ground" ,
		pipe_h         = "heat-pipe" ,
		...
		w_f            = "fluid-wagon" ,
		w_a            = "artillery-wagon" ,
		rob_c          = "construction-robot" ,
		rob_l          = "logistic-robot" ,
		rob_a          = "combat-robot" ,
		roboport       = "roboport" ,
...
SIKeyw =
{
	...
	[SITypes.item.item_e]           = "item" ,
	[SITypes.item.tool]             = "tool" ,
	[SITypes.item.tool_r]           = "tool" ,
	[SITypes.item.tool_m]           = "tool" ,
	[SITypes.item.rail_p]           = "rail" ,
	...
	[SITypes.item.blueprint_book]   = "tool" ,
	[SITypes.item.redprint]         = "tool" ,
	[SITypes.item.selection_tool]   = "tool" ,
	...
	[SITypes.entity.rob_c]          = "robot" ,
	[SITypes.entity.rob_l]          = "robot" ,
	[SITypes.entity.rob_a]          = "robot" ,
